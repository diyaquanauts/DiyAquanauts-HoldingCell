...
class ObjectCounter:
    frame_count = 0
    child_colors = [(0, 255, 0), (173, 216, 230), (0, 0, 255), (255, 255, 0),
                    (255, 165, 0), (128, 0, 128), (230, 230, 250), (255, 0, 255),
                    (70, 130, 180), (144, 238, 144)]
                    ...
                    if area > 3:  # Lowered the threshold for contour area (adjust as needed)
                        ...
                        if cv2.isContourConvex(contour):
                            ...
                            if hierarchy[0][i][3] != -1:
                                ...
                                cv2.drawContours(frame, contours, parent_index, (0, 0, 255), 0)  # Fill parent in red
                            else:
                                object_count += 1
                                # Generate a random color for child objects from the predefined set
                                random_color = random.choice(self.child_colors)
                                # Fill child objects with the random color
                                cv2.drawContours(frame, contours, i, random_color, 4)
